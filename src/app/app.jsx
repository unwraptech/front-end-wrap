...
import AdminToolbar from "./components/admin-dash/toolbar"
import * as AdminActions from "../app/redux/actions/admin-actions"
...
componentDidMount(){
  ...
  render() {
    ...
    return (
      <div className="App"style={{backgroundColor:"#F4F5F5"}}>
