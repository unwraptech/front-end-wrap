...
class CompareMobile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchmobile_list: [],
  ...
  search_mobiles = (search) => {
    ...
    this.props.search_mobiles(search).then(data => {
      ...
      <div style={{ marginLeft: "10%", marginRight: "10%" }}>
        <Row style={{ height: "45px" }}>
          <Col style={{ border: "solid #FFFFFF 1px" }} span={6}>
            <Select
              style={{ width: "100%", padding: "5px" }} placeholder="Please select Mobile"
...
export default connect(mapStateToProps, mapDispatchToProps)(CompareMobile);
