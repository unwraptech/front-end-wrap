...
import Logo from "../../assets/images/unwrap-logo.png";
  ...
  render(){
    ...
    const menu = (
      <Menu style={{background:"#000"}}>
        <Menu.Item><a onClick={()=>this.props.history.push('/mobile/comparemobiles')} style ={{color:"#FFF",borderBottom:"solid #FFF 1px"}}>Mobiles</a></Menu.Item>
    ...
    {this.state.role ? 
      ...
      <Navbar style={{background:"#000",marginLeft:"10%",marginRight:"10%",marginTop:"1px"}}>
        ...
        <a onClick={()=>this.props.history.push('search')} style ={{color:"#FFF", width :"12%"}}>Latest Devices</a>
        <a onClick={()=>this.props.history.push('/technology/news')} style ={{color:"#FFF", width :"12%"}}>Tech News</a>
        <a onClick={()=>this.props.history.push('search')} style ={{color:"#FFF", width :"12%"}}>FAQ</a>
